      ...
      <Collapse>
        <Collapse.Trigger>
          <div
            ...
            style={{ background: completed ? "#441678" : "#ef9118" }}
          >
            <h3>{name}</h3>
            <h3>{orderedDate}</h3>
            <h3>{submitDate}</h3>
        ...
        <Collapse.Content>
          <div className="order__info">
            ...
            <Button
              btnStyle="primary"
              type="button"
              style={{ width: "30rem", margin: "0 2rem", marginLeft: "5rem" }}
              onClick={() =>
                updateOrder({ ...order, completed: !completed }, history)
              }
            >
            ...
            <Button
              ...
              type="button"
              style={{ width: "30rem" }}
              onClick={() => deleteOrder(id, history)}
            >
              Delete Order
            </Button>
          </div>
